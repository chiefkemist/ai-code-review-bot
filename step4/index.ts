...
import { AxOpenAIProvider, AxAnthropicProvider, AxGeminiProvider } from "./llm-providers.ts";
...
class AICodeReviewer {
  ...
  constructor() {
    ...
    if (openaiKey) {
      this.providers.openai = new AxOpenAIProvider(openaiKey);
    }

    if (anthropicKey) {
      this.providers.anthropic = new AxAnthropicProvider(anthropicKey);
    }

    if (googleKey) {
      this.providers.gemini = new AxGeminiProvider(googleKey);
    }
  }
